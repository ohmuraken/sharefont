...
/*
    ...
    <div class="twBtn" style="left:130px; top:0px">
  ...
  //0と1を数えていって(その数をiとして)
    ...
    <div class="twBtn" style="left:65*ipx; top:20*ipx">
      <img src="img/twit.png" />
    </div>
  ...
  */
  ...
  while((letter = fgetc(in_fp)) != EOF){
    ...
    if(letter=='0'){
      ...
      printf("<div class='twBtn' style='left:%dpx; top:%dpx'><div class='tweet'></div></div>", (count_gyo)*YOKO, count_retsu*TATE);
      printf("<div class='twBtn' style='left:%dpx; top:%dpx'><div class='tweet'></div></div>", (count_gyo)*YOKO, count_retsu*TATE+20);
      printf("<div class='twBtn' style='left:%dpx; top:%dpx'><div class='tweet'></div></div>", (count_gyo)*YOKO, count_retsu*TATE+40);
